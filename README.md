...
Currently, we provide one pre-trained detector and a script to test it on clean and adversarial images. More pre-trained models and a training script for your own models will be added soon. More details can be found in our [paper](openreview.net/forum?id=0CY5APFnFI).
